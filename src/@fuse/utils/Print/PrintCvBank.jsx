...
const PrintCvBank = forwardRef(({ title, type }, ref) => {
  ...
  const getFemaleCvData = async (id) => {
    try {
      const response = await axios.get(`${CREATE_PRINT_CV_BANK}${id}`, {
        headers: {
  ...
  return (
    ...
    >
      <div className="w-full p-32" style={{ minHeight: "270px" }}>
        {" "}
        <table className="mt-40 text-center">
          <tr>
            ...
            <td width="25%" className="object-none object-right">
              <img
        ...
        <h1 className="text-center  p-10 w-25 my-20">
          {" "}
          <span className="border border-black rounded p-10">
            BIO-DATA
          </span>{" "}
        </h1>
        <table
        ...
        >
          <tr>
            ...
            <td width="25%" className="border border-black">
              {" "}
              {data?.id}{" "}
            </td>
        ...
        >
          <tr>
            <td width="25%">NAME</td>
            <td width="75%" className="border border-black">
              {" "}
              {data?.passenger_name}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td width="75%" className="border border-black">
              {data?.village} ,{data?.police_station?.name} ,
              {data?.district?.name} -{data?.post_office}
            </td>
          </tr>
        </table>
        <table
        ...
        >
          <tr>
            ...
            <td width="25%" className="border border-black">
              {moment(new Date(data?.passport_issue_date)).format("DD-MM-YYYY")}
            </td>
          </tr>
          <tr>
            <td width="25%"> &nbsp;</td>
        ...
        <table width="100%" className="mt-40 border-separate border-spacing-4">
          <tr>
...
export default memo(PrintCvBank);
