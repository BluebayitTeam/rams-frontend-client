...
import { BASE_URL, CREATE_PRINT_CV_BANK, GET_SITESETTINGS } from 'src/app/constant/constants';
				...
				>
					...
					<tr>
						...
						<td
							...
							className="border border-black"
						>
							{data?.village} ,{data?.police_station?.name} ,{data?.district?.name} -{data?.post_office}
						</td>
					</tr>
				</table>
				<table
