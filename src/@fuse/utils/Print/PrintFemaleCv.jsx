...
setData(response?.data)
  ...
  return (
 	<>
			...
			<div className="w-full" style={{ minHeight: '270px' }}>
				<div ref={componentRef} id="downloadPage" className="p-10">
					<table>
						<tr>
							<td width="25%">
								<img src={`${BASE_URL}${generalData?.logo}`} width="200px" className="text-center" />
							</td>{' '}
							<td width="50%">
								<center>
									<table>
							...
							<td width="50%">
								<table cellpadding="5" cellspacing="2" width="100%">
									...
									<tr>
										...
										<td className="border border-black text-center">
											{moment(new Date(femaleCVPrint?.passenger?.date_of_birth)).format(
												'DD-MM-YYYY'
											)}
										</td>
						...
						<tr>
							...
							<td width="60%">
								<p className="border border-black p-10">
									I HERE BY DECLARATE THAT THE ABOVE PARTICULARS FURNISHED BY ME ARE TRUE AND ACCURATE
					...
					<table cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<td width="100%">
								<table cellpadding="5" cellspacing="2" width="100%">
									<tr>
										<td className="border border-black " width="30%">
											{' '}
											What I Can Do For
										</td>
										<td className="border border-black " width="70%">
											{' '}
											&nbsp;
										</td>
									</tr>
