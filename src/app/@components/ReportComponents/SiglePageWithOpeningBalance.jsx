            ...
            {typeof addInHeader === 'number' ? (
              addInHeader > 0 ? (
                <h3 style={{ color: 'green' }}>
                  Opening Balance: {addInHeader.toFixed(2)} Cr
                </h3>
              ) : (
                <h3 style={{ color: 'red' }}>
                  Opening Balance: {addInHeader.toFixed(2)} Dr
                </h3>
              )
            ) : null}
          </div>
          ...
          <TableBody>
            {data?.data?.map((dataArr, idx) => (
              <TableRow
                ...
                hover
                style={{
                  backgroundColor: dataArr?.is_post_date && 'rgb(251 234 234)',
                }}>
                      ...
                      <div
                        ...
                        {column?.subName
                          ...
                          : column.type === 'date'
                            ...
                            : column.type === 'amount'
                              ? dataArr?.[column.name]
                                ? parseFloat(dataArr[column.name]).toFixed(2) ||
                                  0.0
                                : '0.00'
                              : column.name
                                ? dataArr?.[column.name]
