...
function SiglePageWithExtraHeading({
	classes,
	reportTitle = 'Report',
	tableColumns = [],
	filteredData,
...
{/* Extra Heading  */}
				...
				<div className={classes.pageHead}>
					<p className="title  pl-0 md:-pl-20">{` ${generalData?.address || ''}`}</p>
				</div>

				<div className={classes.pageHead}>
					<p className="title  pl-0 md:-pl-20">
						{`Mobile:  ${generalData?.phone || ''}`} {`Email : ${generalData?.email || ''}`}
					</p>
				</div>
...
export default SiglePageWithExtraHeading;
