...
export const getRole = createAsyncThunk('roleManagement/role/getRole', async params => {
	const authTOKEN = {
		headers: {
...
export const removeRole = createAsyncThunk('roleManagement/role/removeRole', async val => {
	const authTOKEN = {
		headers: {
			'Content-type': 'application/json',
			Authorization: sessionStorage.getItem('jwt_access_token')
...
export const saveRole = createAsyncThunk('roleManagement/role/saveRole', async roleData => {
	const authTOKEN = {
		headers: {
			'Content-type': 'application/json',
			Authorization: sessionStorage.getItem('jwt_access_token')
