...
function SalarySlipsFilterMenu({
  inShowAllMode,
  handleGetSalarySlipss,
  handleGetAllSalarySlipss,
}) {
  ...
  const commonFieldProps = {
    setReRender,
    onEnter: () =>
      inShowAllMode ? handleGetAllSalarySlipss() : handleGetSalarySlipss(),
  };
...
export default SalarySlipsFilterMenu;
