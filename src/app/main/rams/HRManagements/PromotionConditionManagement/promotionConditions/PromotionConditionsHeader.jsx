...
/**
 * The promotionConditions header.
 */
function PromotionConditionsHeader(props) {
    ...
    >
      ...
      <div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
        ...
        >
          ...
          <Input
            placeholder="Search promotionConditions"
        ...
        >
          ...
          <Button
            ...
            to="/apps/promotionCondition/promotionConditions/new"
          >
...
export default PromotionConditionsHeader;
