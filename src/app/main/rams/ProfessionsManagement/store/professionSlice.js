...
import { CREATE_PROFESSION, DELETE_PROFESSION, GET_PROFESSION_BY_ID, UPDATE_PROFESSION } from '../../../../constant/constants';

export const getProfession = createAsyncThunk('professionManagement/profession/getProfession', async (params, { rejectWithValue }) => {
    const authTOKEN = {
        headers: {
...
export const removeProfession = createAsyncThunk(
    'professionManagement/profession/removeProfession',
    async (val) => {
...
const professionSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateProfession.fulfilled]: (state, action) => action.payloHea
    }
})
