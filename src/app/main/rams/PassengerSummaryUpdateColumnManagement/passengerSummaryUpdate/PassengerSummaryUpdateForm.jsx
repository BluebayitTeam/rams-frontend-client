...
function PassengerSummaryUpdateForm(props) {
    ...
    <div>
      ...
      <Controller
        name='passengerSummaryUpdate_no'
        control={control}
        render={({ field }) => {
          return (
            <TextField
              {...field}
              className='mt-8 mb-16'
              helperText={errors?.passengerSummaryUpdate_no?.message}
              label='PassengerSummaryUpdate No'
              id='passengerSummaryUpdate_no'
              type='number'
              variant='outlined'
              InputLabelProps={
                field.value ? { shrink: true } : { style: { color: 'red' } }
      ...
      <Controller
        ...
        render={({ field: { onChange } }) => (
          <div className='flex w-full flex-row items-center justify-center ml-16'>
            ...
            {previewslipPicFile ? (
              <div
                style={{ width: 'auto', height: '150px', overflow: 'hidden' }}>
                {fileExtPCName &&
...
export default PassengerSummaryUpdateForm;
