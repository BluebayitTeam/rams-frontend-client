...
function EvisaEntrysTable(props) {
  ...
  const evisaEntrys = useSelector(
    selectFilteredEvisaEntrys(data?.evisa_entries)
  );
                ...
                <TableRow
                  ...
                  <TableCell
                    ...
                    {hasPermission('EVISA_ENTRY_UPDATE') && (
                      <Edit
                        onClick={() =>
                          handleUpdateEvisaEntry(n, 'updateEvisaEntry')
                        }
                    ...
                    {hasPermission('EVISA_ENTRY_DELETE') && (
                      <Delete
                        onClick={() =>
                          handleDeleteEvisaEntry(n, 'deleteEvisaEntry')
                        }
