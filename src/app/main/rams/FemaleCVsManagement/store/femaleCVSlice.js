...
export const removeFemaleCV = createAsyncThunk('femaleCVManagement/femaleCV/removeFemaleCV', async val => {
	const authTOKEN = {
		headers: {
...
export const updateFemaleCV = createAsyncThunk('femaleCVManagement/femaleCV/updateFemaleCV', async femaleCVData => {
...
export const saveFemaleCV = createAsyncThunk('femaleCVManagement/femaleCV/saveFemaleCV', async femaleCVData => {
...
const femaleCVSlice = createSlice({
	...
	extraReducers: {
		...
		[updateFemaleCV.fulfilled]: (state, action) => action.payload
	}
});
