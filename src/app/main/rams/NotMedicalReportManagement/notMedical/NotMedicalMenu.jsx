...
function NotMedicalsFilterMenu({
  inShowAllMode,
  handleGetNotMedicals,
  handleGetAllNotMedicals,
}) {
  ...
  const renderFunction = () => {
    if (loop == true) {
      inShowAllMode ? handleGetAllNotMedicals() : handleGetNotMedicals();
      setLoop(false);
    }
  };
...
export default NotMedicalsFilterMenu;
