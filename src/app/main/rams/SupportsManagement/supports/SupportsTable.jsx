...
function SupportsTable(props) {
  ...
  // const { data, isLoading, refetch } = useGetSupportsQuery({
  //   ...pageAndSize,
  //   searchKey,
  // });
  ...
  return (
    <div className="w-full flex flex-col">
                    ...
                    >
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            checked={
                              field.value === "open" ? field.value : false
                            }
                            style={{ color: "green" }}
                          />
                        }
                      ...
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            checked={
                              field.value === "in_process" ? field.value : false
                            }
                            style={{ color: "#22d3ee" }}
                          />
                        }
                      ...
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            checked={
                              field.value === "closed" ? field.value : false
                            }
                            style={{ color: "red" }}
                          />
                        }
      ...
      <FuseScrollbars className="flex-grow overflow-x-auto">
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        ...
                        style={{ marginRight: "5px" }}
                      >
                        <span style={{ fontWeight: 700, marginLeft: "40px" }}>
                          Subject:{" "}
                        </span>
                        {` ${support?.subject}`}
                      </Typography>
        ...
        <div id="pagiContainer" className="flex justify-between	">
          <Pagination
