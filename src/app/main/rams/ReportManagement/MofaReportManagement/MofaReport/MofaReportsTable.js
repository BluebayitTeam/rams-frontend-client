...
const initialTableColumnsState = [
	...
	{ id: 8, label: 'M.Status', name: 'mofa_status', show: true },
	{ id: 9, label: 'Re M.Status', name: 're_mofa_status', show: true },
	{ id: 10, label: 'Re M.Charge', name: 're_mofa_charge', show: true },
	{ id: 11, label: 'why ReMofa', name: 'mofa_no', show: true }
];
