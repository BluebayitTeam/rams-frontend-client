...
const initialTableColumnsState = [
	...
	{ id: 6, label: 'Submit Date', name: 'submit_date', show: true, type: 'date' },
	...
	{ id: 12, label: 'Stp Date', name: 'stamping_date', show: true, type: 'date' },
	{ id: 13, label: 'V.Exp Date', name: 'visa_expiry_date', show: true, type: 'date' },
	{ id: 14, label: 'Delivery Date', name: 'delivery_date', show: true, type: 'date' },
	{ id: 15, label: 'recruiting_agency', name: 'recruiting_agency', subName: 'name', show: true }
];
