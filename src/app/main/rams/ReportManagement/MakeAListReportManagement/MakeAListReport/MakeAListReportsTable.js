...
const MakeAListReportsTable = () => {
	...
	const [modifiedMakeAListData, setModifiedMakeAListData, setSortBy] = useReportData();
	...
	const firstPageHandler = event => {
		handleGetMakeALists(event.page);
	};
		...
		<>
			...
			<div className={`${classes.menubar} justify-start md:justify-center`}>
				...
				<FontAwesomeIcon
					...
					onClick={() => handleGetAllMakeALists()}
					icon={faScroll}
				/>
			...
			<table id="table-to-xls" className="w-full" style={{ minHeight: '270px' }}>
				<div ref={componentRef} id="downloadPage">
					...
					{modifiedMakeAListData.map(makeAList => (
						<SinglePage
							classes={classes}
							generalData={generalData}
							reporTitle="MakeAList Report"
							tableColumns={tableColumns}
							dispatchTableColumns={dispatchTableColumns}
							data={makeAList}
							serialNumber={makeAList.page * makeAList.size - makeAList.size + 1}
							setPage={setPage}
