...
/**
 * The callingEntrys header.
 */
function CallingEntrysHeader(props) {
	...
	return (
		<div className="flex flex-col sm:flex-row space-y-12 sm:space-y-0 flex-1 w-full justify-between py-32 px-24 md:px-32">
			...
			>
				<Typography className="text-24 md:text-32 font-extrabold tracking-tight">Calling Entry</Typography>
			</motion.span>
			...
			<div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
				...
				>
					...
					<Input
						placeholder="Search by profession(english) or visa no"
				...
				<ViewWeek
					onClick={() => navigate(`/apps/column/columns/calling_entry`)}
				...
				>
					<Button
						...
						to="/apps/callingEntry/callingEntrys/new"
					>
...
export default CallingEntrysHeader;
