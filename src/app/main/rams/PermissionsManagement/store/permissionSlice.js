...
export const getPermission = createAsyncThunk(
	'permissionManagement/permission/getPermission',
...
export const removePermission = createAsyncThunk('permissionManagement/permission/removePermission', async val => {
	const authTOKEN = {
		headers: {
			'Content-type': 'application/json',
			Authorization: localStorage.getItem('jwt_access_token')
