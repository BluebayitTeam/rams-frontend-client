...
function VisaEntryDetailPrint({ classes, data }) {
  const navigate = useNavigate();

  const gotoEditpage = () => {
    navigate(`/apps/visaEntry/visaEntrys/${data.id}/fromSearch`);
  };
...
export default VisaEntryDetailPrint;
