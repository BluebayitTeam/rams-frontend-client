...
import { CREATE_VISAENTRY, DELETE_VISAENTRY, GET_VISAENTRY_BY_ID, UPDATE_VISAENTRY } from '../../../../constant/constants';


export const getVisaEntry = createAsyncThunk('visaEntryManagement/visaEntry/getVisaEntry', async (params, { rejectWithValue }) => {
    const authTOKEN = {
        headers: {
...
export const removeVisaEntry = createAsyncThunk(
    'visaEntryManagement/visaEntry/removeVisaEntry',
    async (val) => {
...
export const saveVisaEntry = createAsyncThunk(
    'visaEntryManagement/visaEntry/saveVisaEntry',
    async (visaEntryData) => {
...
const visaEntrySlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateVisaEntry.fulfilled]: (state, action) => action.payloHea
    }
})
