...
/**
 * The payHeadTypes header.
 */
function PayHeadTypesHeader(props) {
    ...
    >
      ...
      <div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
        ...
        >
          ...
          <Input
            placeholder="Search payHeadTypes"
        ...
        >
          ...
          <Button
            ...
            to="/apps/payHeadType/payHeadTypes/new"
          >
...
export default PayHeadTypesHeader;
