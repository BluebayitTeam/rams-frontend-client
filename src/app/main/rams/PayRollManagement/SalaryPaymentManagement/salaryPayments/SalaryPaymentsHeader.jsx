...
/**
 * The salaryPayments header.
 */
function SalaryPaymentsHeader(props) {
    ...
    <div className='flex flex-col sm:flex-row space-y-12 sm:space-y-0 flex-1 w-full justify-between py-32 px-24 md:px-32'>
      ...
      <div className='flex w-full sm:w-auto flex-1 items-center justify-end space-x-8'>
        <Paper
          ...
          <Input
            placeholder='Search salaryPayments'
        ...
        <motion.div
          ...
          <Button
            ...
            to='/apps/salaryPayment/salaryPayments/new'>
...
export default SalaryPaymentsHeader;
