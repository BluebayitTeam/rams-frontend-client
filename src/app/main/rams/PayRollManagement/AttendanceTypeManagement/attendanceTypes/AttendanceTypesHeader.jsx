...
/**
 * The attendanceTypes header.
 */
function AttendanceTypesHeader(props) {
    ...
    >
      ...
      <div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
        ...
        >
          ...
          <Input
            placeholder="Search attendanceTypes"
        ...
        >
          ...
          <Button
            ...
            to="/apps/attendanceType/attendanceTypes/new"
          >
...
export default AttendanceTypesHeader;
