...
function DemandFilterMenu({
  ...
  const commonFieldProps = {
    setReRender,
    onEnter: () => (inShowAllMode ? handleGetAllDemands() : handleGetDemands()),
  };
  const commonKewordProps = {
    setReRender,
    onClick: () => (inShowAllMode ? handleGetAllDemands() : handleGetDemands()),
  };
...
export default DemandFilterMenu;
