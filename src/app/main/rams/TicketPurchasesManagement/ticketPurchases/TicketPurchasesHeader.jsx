...
/**
 * The ticketPurchases header.
 */
function TicketPurchasesHeader(props) {
    ...
    >
      ...
      <div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
        <Paper
          ...
          className="flex items-center w-full sm:max-w-[540px] space-x-8 px-16 rounded-full border-1 shadow-0"
        >
          <FuseSvgIcon color="disabled">heroicons-solid:search</FuseSvgIcon>

          <Input
            placeholder="Search By ticket Purchases"
        ...
        >
          {hasPermission("DEPARTMENT_CREATE") && (
            <Button
              ...
              to="/apps/ticketPurchase/ticketPurchases/new"
            >
...
export default TicketPurchasesHeader;
