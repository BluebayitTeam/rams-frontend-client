...
function PaymentFilterMenu({ inShowAllMode, handleGetPayments, handleGetAllPayments }) {
	...
	const paymentCodeEl = useRef(null);

	const commonFieldProps = {
		setReRender,
		onEnter: () => (inShowAllMode ? handleGetAllPayments() : handleGetPayments())
	};
	const commonKewordProps = {
		setReRender,
		onClick: () => (inShowAllMode ? handleGetAllPayments() : handleGetPayments())
	};
