...
const schema = z.object({
  first_name: z
    .string()
    .nonempty('You must enter a embassyReport name')
    .min(5, 'The embassyReport name must be at least 5 characters'),
});

function EmbassyReport() {
