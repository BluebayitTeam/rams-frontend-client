...
// import ReportSelectEmbassy from 'src/app/@components/ReportComponents/ReportSelectEmbassy';

const useStyles = makeStyles((theme) => ({
  ...getReportFilterMakeStyles(theme),
}));

function EmbassyFilterMenu({
  inShowAllMode,
  handleGetEmbassys,
  handleGetAllEmbassys,
}) {
  ...
  return (
    <div className={classes.filterMenuContainer}>
      ...
      <div>
        <ViewWeek
          onClick={() => navigate(`/apps/reportClm/reportClms/embassy`)}
