...
function ReceiptVoucherHeader({ letFormSave }) {
  ...
  function handleUpdateReceiptVoucher() {
    ...
    saveReceiptVoucher({ ...getValues(), id: receiptVoucherId }).then(
      (data) => {
        UpdatedSuccessfully();
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center max-w-full">
          ...
          >
            {images && images.length > 0 && featuredImageId ? (
              ...
              <img
                className="w-32 sm:w-48 rounded"
                src="assets/images/apps/ecommerce/receiptVoucher-image-placeholder.png"
                alt={name}
              />
            )}
          </motion.div>
      ...
      >
        ...
        {receiptVoucherId === "new" &&
          hasPermission("RECEIPT_VOUCHER_CREATE") && (
            <Button
        ...
        {handleDelete !== "deleteReceiptVoucher" &&
          handleUpdate === "updateReceiptVoucher" &&
          receiptVoucherId !== "new" &&
