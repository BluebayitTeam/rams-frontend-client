...
function FeMaleCVPrint() {
	...
	const femaleCVPrint = useSelector(({ femaleCVPrintsManagement }) => femaleCVPrintsManagement.femaleCVPrint);

	const [showPrint, setShowPrint] = useState(false);
	useEffect(() => {
		dispatch(getFemaleCVPrint());
	}, []);
