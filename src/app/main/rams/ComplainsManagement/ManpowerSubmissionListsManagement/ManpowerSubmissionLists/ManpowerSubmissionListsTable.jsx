...
function ManpowerSubmissionListsTable(props) {
  ...
  function deleteManpowerSubmissionList(item, event) {
    ...
    navigate(
      `/apps/manpowerSubmissionList/manpowerSubmissionLists/${item.id}/${item.handle}`
    );
  }
      ...
      {tableShow && (
        <div>
          ...
          >
            ...
            <table width="100%" align="center" className="px-32 w-11/12">
              <tr>
                <td>
                  নিয়োগকারী দেশের নাম :
              ...
              <tr>
                <td>
                  ...
                  <span style={{ fontWeight: "bold" }}>
                    {getValues()?.agency_info?.name_bangla}
                  </span>
                </td>
                ...
                <td style={{ textAlign: "right" }}>
                  ...
                  <span style={{ fontWeight: "bold", paddingRight: "10px" }}>
                    {moment(
                      new Date(data?.[0]?.man_power_list?.man_power_date)
                    ).format("DD-MM-YYYY")}
                  </span>
                </td>
              </tr>
            ...
            <p style={{ margin: "10px" }}>
              <span style={{ fontWeight: "bold" }}>
                এজেন্সীর অঙ্গীকার নামা :
              </span>
              বর্ণিত কর্মী গ্রুপ ভিসার অন্তর্ভুক্ত নয় কর্মীর/কর্মীদের পাসপোর্ট,
              ভিসা, চাকরীর চুক্তি পএরে বর্নিত বেতন ও শর্তাদি সঠিক আছে উক্ত বিষয়ে
              নিক্রটিং কারনে কর্মীর/কর্মীদের কোন প্রকার সমস্যা হইলে আমার
              <span style={{ fontWeight: "bold" }}>
              ...
              সম্পূর্ন দায় দায়িত্ব গ্রহন ও কর্মীর/কর্মীদের ক্ষতিপূরণ দান করিতে
              বাধ্য থাকিবো
            </p>
