...
import { useDeleteDemandsMutation } from '../ComplainsApi';
/**
 * The table head rows data.
 */

/**
 * The demands table head component.
 */
function DemandsTableHead(props) {
  const {
    selectedDemandIds,
    tableOrder,
    onSelectAllClick,
  ...
  const [removeDemands] = useDeleteDemandsMutation();
