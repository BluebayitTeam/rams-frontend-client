...
function TicketSaleReportsTable(props) {
  ...
  const [airlineprinttableColumns, dispatchAirlinePrintTableColumns] =
    useReducer(tableColumnsReducer, initialAirlinePrintTableColumnsState);
  const [customerprinttableColumns, dispatchCustomerPrintTableColumns] =
    useReducer(tableColumnsReducer, initialCustomerPrintTableColumnsState);
  ...
  const [totalAirlineCommissionAmount, setTotalAirlineCommissionAmount] =
    useState(0);
  const [totalCustomerCommisionAmount, setTotalCustomerCommisionAmount] =
    useState(0);
    ...
    <div className={classes.headContainer}>
      ...
      <div
        ...
        <table
          id='table-to-xls'
          className='w-full'
          style={{ minHeight: '270px', display: 'none' }}>
