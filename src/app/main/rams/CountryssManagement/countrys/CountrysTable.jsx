...
function CountrysTable(props) {
  ...
  const { data, isLoading, refetch } = useGetCountrysQuery({
    ...pageAndSize,
    searchKey,
  });
      ...
      <FuseScrollbars className='grow overflow-x-auto'>
        <TableContainer
          ...
          <Table stickyHeader className='min-w-xl' aria-labelledby='tableTitle'>
            ...
            <TableBody>
              {_.orderBy(countrys, [tableOrder.id], [tableOrder.direction]).map(
                (n) => {
                  ...
                  return (
                    <TableRow
                      ...
                      <TableCell
                        ...
                        <Edit
                          onClick={(event) =>
                            handleUpdateCountry(n, 'updateCountry')
                          }
                        ...
                        <Delete
                          onClick={(event) =>
                            handleDeleteCountry(n, 'deleteCountry')
                          }
