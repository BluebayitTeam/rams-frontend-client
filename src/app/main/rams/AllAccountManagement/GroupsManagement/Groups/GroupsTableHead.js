...
import { getGroups, removeGroups } from '../store/groupsSlice';
		...
		<TableHead>
			<TableRow className="h-48 sm:h-64">
				<TableCell padding="none" className="w-40 md:w-64 text-center z-99">
					{props.rowCount !== 0 && !_.isEmpty(selectedGroupIds) ? (
						<div className="pt-2">
							<IconButton
								className="p-0"
							...
							>
								<MenuList>
									<MenuItem
										onClick={() => {
											dispatch(removeGroups(selectedGroupIds)).then(res => {
												res.payload && dispatch(getGroups(props.pagination));
											});
