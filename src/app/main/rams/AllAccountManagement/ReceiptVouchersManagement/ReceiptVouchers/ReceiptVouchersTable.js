...
import { SEARCH_RECEIPTVOUCHER } from '../../../../../constant/constants';
...
const ReceiptVouchersTable = props => {
	...
	const getSearchReceiptVoucher = () => {
		fetch(`${SEARCH_RECEIPTVOUCHER}?invoice_no=${searchText}`)
			.then(response => response.json())
			.then(searchedReceiptVoucherData => {
				setSearchReceiptVoucher(searchedReceiptVoucherData?.receipt_vouchers);
				console.log('searchedReceiptVoucherData', searchedReceiptVoucherData);
			})
