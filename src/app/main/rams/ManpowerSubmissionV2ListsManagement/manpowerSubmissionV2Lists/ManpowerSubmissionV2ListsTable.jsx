...
function ManpowerSubmissionV2ListsTable(props) {
  ...
  const [removeManpowerSubmissionV2Lists] =
  ...
  function deleteManpowerSubmissionV2List(item) {
    ...
    DeletedSuccessfully();
    navigate(
      `/apps/manpowerSubmissionV2List/manpowerSubmissionV2Lists/${item.id}/${item.handle}`
    );
  }
            ...
            <tbody>
              {columns.map((column) => (
                <tr key={column}>
                  ...
                  {data?.data
                    ?.slice(startRowIndex, startRowIndex + rowsPerPage)
                    .map((row, rowIndex) => (
                      <td
          ...
          {!printableFormat ? (
            <div>
              ...
              >
                ...
                >
                  <TableHead
                    style={{ backgroundColor: "#D7DBDD", height: "35px" }}
                  >
                    <TableRow>
