...
import { useGetTraningSaudiReportsQuery } from '../ManPowerSaudiReportsApi';
...
function TraningSaudiReportsTable(props) {
  ...
  const { data: paginatedData } = useGetTraningSaudiReportsQuery({
  ...
  useEffect(() => {
    if (!inShowAllMode && paginatedData) {
      setModifiedFlightFlightDoneData(paginatedData?.trainings || []);
...
export default TraningSaudiReportsTable;
