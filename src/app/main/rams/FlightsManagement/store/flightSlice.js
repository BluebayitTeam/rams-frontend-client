...
export const removeFlight = createAsyncThunk(
    'flightManagement/flight/removeFlight',
    async (val) => {
...
export const updateFlight = createAsyncThunk(
    'flightManagement/flight/updateFlight',
    async (flightData) => {
...
export const saveFlight = createAsyncThunk(
    'flightManagement/flight/saveFlight',
    async (flightData) => {
...
const flightSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateFlight.fulfilled]: (state, action) => action.payloHea
    }
})
