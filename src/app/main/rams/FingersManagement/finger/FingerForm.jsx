...
function FingerForm(props) {
  ...
  const { data, refetch, isSuccess } = useGetFingerQuery(fingerId, {
    skip: !fingerId,
  });
  ...
  useEffect(() => {
    setFingerId(routeParams?.fingerId);
    if (routeParams?.fingerId !== 'ksa-visa-form') {
      setValue('name', routeParams?.fingerId);
    }
  }, [routeParams?.fingerId, setValue]);
          ...
          <div className='md:w-full'>
            <div>
              <table width='100%' cellpadding='1' cellspacing='1'>
                <tr>
                  <td valign='middle' style={{ width: '20%', padding: 0 }}>
                    <img
                ...
                <tr
                  ...
                  <td
                    ...
                    <small style={{ fontSize: '70%' }}>
                      <center>
                        আবেদনকারীর পাসপোর্টের প্রথম দুই (২) পৃষ্ঠার ফটোকপি আবেদন
                        ফর্মের সাথে অবশ্যই জমা দিতে হবে। তারকা
                        চিহ্নিত(+)তথ্যগুলো অবশ্যই পূরণীয় ।ফর্মটি পূরণ করার
                        পূর্বে অনুগ্রহপূর্বক শেষ পৃষ্ঠায় বর্নিত নির্দেশনাসমূহ
                        পড়ুন । <br /> (A copy of the first two(2)page of
                        applicant must be submitted with the application
                        form.Information marked as start must be filled ,please
                        read the instruction as the last page before filling the
                        form)
                      </center>
                    </small>
                  </td>
              ...
              <table width='100%'>
                <tr>
                  <td style={{ border: '1px solid black', padding: '2px' }}>
                    <center>
                      {' '}
                      Applicant’s Personal Information ( আবেদনকারী ব্যক্তিগত
                      তথ্য )
                    </center>
                  </td>
                </tr>
              ...
              <table
                ...
                <tr>
                  ...
                  <td colspan='3' style={{ borderBottom: '1px dashed' }} />
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    *Passport Expiry Date ( পাসপোর্টের মেয়াদোওির্ণের তারিখ )
                  </td>
                  <td style={{ borderBottom: '1px dashed' }}>
                    {' '}
                    ...
                    <table width='100%'>
                      <tr>
                        <td
                          ...
                          <center>
                            {' '}
                            Applicant’s Contact Information ( আবেদনকারী
                            যোগাযোগের তথ্য )
                          </center>
                        </td>
                      </tr>
                ...
                <tr>
                  ...
                  <td style={{ borderBottom: '1px dashed' }} colspan='3'>
                ...
                <tr>
                  <td colspan='4'>
                    <div style={{ display: 'flex', paddingLeft: '15px' }}>
                      ...
                      <div>
                        Put tick (🗸) if Permanent Address is same as the Mailing
                        Address
                        <br />( স্থায়ী ঠিকানা ও যোগাযোগের ঠিকানা একই হলে (🗸)
                        চিহ্ন দিন )
                      </div>
                    </div>
                  </td>
                    ...
                    <table width='100%'>
                      <tr>
                        <td
                          style={{ border: '1px solid black', padding: '2px' }}>
                          <center>
                            *Job Preference ( চাকরীর অগ্রাধিকার ) <br /> ( আপনি
                            যে চাকরীগুলো করতে আগ্রহী সেগুলোর নাম উল্লেক করুন ।
                            যে কোনো একজন আবেদনকারী সর্বোচ্চ ৩টি পেশা উল্লেখ করতে
                            পারবেন ।)
                          </center>
                        </td>
                      </tr>
                    ...
                    <table width='100%' cellspacing='0'>
                      <tr>
                        <td
                          style={{ border: '1px solid black', padding: '2px' }}>
                          <center>
                            Academic Qualification and Language Skills (
                            শিক্ষাগত যোগ্যতা ও ভাষাগত দক্ষতা )
                          </center>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td>
                    Educational Qualification( শিক্ষাগত যোগ্যতা উল্লখ করুন ){' '}
                  </td>
                  <td colspan='3' style={{ borderBottom: '1px dashed' }}>
                    {' '}
                  </td>
                ...
                <tr>
                  <td colspan='4'>
                    <table>
                      <tr>
                        <td>
                          Name of the Institute last attended( যে প্রতিষ্ঠান
                          থেকে পাশ করছেন তার নাম উল্লেখ করুন )
                        </td>
                        <td style={{ borderBottom: '1px dashed' }} />
                      </tr>
                    </table>
                  ...
                  <td colspan='4'>
                    <table
                      ...
                      <tr>
                        ...
                        <td colspan='4'>
                          <center>
                            Language Skill(ভাষাগত দক্ষতা) <br /> Put (🗸) in
                            Appropiate Box(🗸 চিহ্ন দিন)
                          </center>
                        </td>
                      </tr>
