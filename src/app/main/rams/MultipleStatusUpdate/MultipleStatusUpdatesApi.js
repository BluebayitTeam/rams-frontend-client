			...
			createMultipleStatusUpdate: build.mutation({
				query: (newMultipleStatusUpdate) => ({
					...
					data: MultipleStatusUpdateModel({
						checkbox: newMultipleStatusUpdate?.checkbox,
						passengers: newMultipleStatusUpdate?.passengers,
						email: newMultipleStatusUpdate?.email
					})
				}),
...
export const { useCreateMultipleStatusUpdateMutation } = MultipleStatusUpdateApi;
