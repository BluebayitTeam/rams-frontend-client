...
import { CREATE_SITESETTING, DELETE_SITESETTING, GET_SITESETTINGID, UPDATE_SITESETTING } from '../../../../constant/constants';

export const getSitesetting = createAsyncThunk('sitesettingManagement/sitesetting/getSitesetting', async (params, { rejectWithValue }) => {
  const authTOKEN = {
    headers: {
