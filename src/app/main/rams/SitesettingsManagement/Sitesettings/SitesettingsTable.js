                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="p-4 md:p-16" align="center" component="th" scope="row">
                                            <div>
                                                <EditIcon onClick={sitesettingEvent => handleUpdateSitesetting(n, "updateSitesettingEvent")} className="cursor-pointer" style={{ color: 'green' }} /> <DeleteIcon onClick={event => handleDeleteSitesetting(n, "deleteSitesettingEvent")} className="cursor-pointer" style={{ color: 'red' }} />
                                            </div>
                                        </TableCell>
