...
function MalaysiaVisaForm(props) {
  ...
  const { data, refetch, isSuccess } = useGetMalaysiaVisaQuery(malaysiaVisaId, {
    skip: !malaysiaVisaId,
  });
  ...
  useEffect(() => {
    setMalaysiaVisaId(routeParams?.malaysiaVisaId);
    if (routeParams?.malaysiaVisaId !== 'ksa-visa-form') {
      setValue('name', routeParams?.malaysiaVisaId);
    }
  }, [routeParams?.malaysiaVisaId, setValue]);
          ...
          <div className='md:w-full p-20'>
            <div>
              ...
              <table
                ...
                <tr>
                  ...
                  <td style={{ width: '25%' }}>
                    <tr>
                      ...
                      <td valign='middle' className='pl-10'>
                ...
                <tr>
                  <td colSpan='3' className='bg-gray-400 font-bold	'>
                    {' '}
                ...
                <tr>
                  <td style={{ width: '25%' }} className=' font-bold'>
                    2. *Jantina <br />
                    &nbsp;&nbsp;&nbsp;&nbsp; Gender{' '}
                  </td>
                  <td style={{ width: '25%' }}>
                ...
                <tr className='mt-6'>
                  ...
                  <td style={{ width: '20%' }} className='w-100  mt-0'>
                ...
                <tr className='mt-6'>
                  <td style={{ width: '25%' }} className=' font-bold' />
                  <td style={{ width: '25%' }} className='w-100 '>
                    <table>
                      <tr>
                        <td align='center'>
                          Hari <br />
                ...
                <tr className='mt-6'>
                  ...
                  <td style={{ width: '25%' }} className='w-100  mt-0'>
                ...
                <tr>
                  <td colSpan='4' className='bg-gray-400 font-bold	'>
                    {' '}
                ...
                <tr className='mt-60'>
                  ...
                  <td colSpan='2' className='w-100  mt-80'>
                    <div className='flex float-right'>
                      {' '}
                      Foramt Tarik 99/99/9999
                    </div>
                  </td>
                </tr>
                ...
                <tr className='mt-6'>
                  <td style={{ width: '25%' }} className=' font-bold pl-80'>
                    Negeri <br /> State
                  </td>
                ...
                <tr className='mt-6'>
                  ...
                  <td valign='middle' width='20%' className='pl-10'>
                    <div className='border border-black  w-28 d-flex mx-10'>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                  </td>
                ...
                <tr className='mt-6'>
                  ...
                  <td colSpan='2' className='w-100  mt-80'>
                    <div className='flex float-right'>
                      {' '}
                      Tandatangan / Penganjur <br /> Signature of Application /
                      Sponsor
                    </div>
                  </td>
                </tr>
                <tr className='mt-60'>
                  <td
                    ...
                    Borang ini Hendaklah ditaip . Tandakan (*) dalam petak yang
                    berkenaan <br /> This form should be typed . Mark (*) in the
                    appropiate box{' '}
                  </td>
