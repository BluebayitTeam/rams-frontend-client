...
import { selectFilteredMedicalCenters, useGetMedicalCentersQuery } from '../MedicalCentersApi';

/**
 * The medicalCenters table.
 */
function MedicalCentersTable(props) {
	...
	const { data, isLoading, refetch } = useGetMedicalCentersQuery({ ...pageAndSize, searchKey });
	const totalData = useSelector(selectFilteredMedicalCenters(data));
	const medicalCenters = useSelector(selectFilteredMedicalCenters(data?.medical_centers));
	let serialNumber = 1;
	...
	function handleClick(item) {
		navigate(`/apps/medicalCenter/medicalCenters/${item.id}/${item.handle}`);
	}
		...
		<div className="w-full flex flex-col min-h-full px-10">
			<FuseScrollbars className="grow overflow-x-auto">
				...
				>
					...
					<TableBody>
						{_.orderBy(medicalCenters, [tableOrder.id], [tableOrder.direction]).map((n) => {
							...
							return (
								...
								>
									...
									>
										...
										<Delete
											onClick={(event) => handleDeleteMedicalCenter(n, 'deleteMedicalCenter')}
