...
/**
 * The medicalCenters header.
 */
function MedicalCentersHeader(props) {
	...
	return (
		<div className="flex flex-col sm:flex-row space-y-12 sm:space-y-0 flex-1 w-full justify-between py-32 px-24 md:px-32">
			...
			>
				<Typography className="text-24 md:text-32 font-extrabold tracking-tight">MedicalCenters</Typography>
			</motion.span>
			...
			<div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
				...
				>
					...
					<Input
						placeholder="Search medicalCenters"
				...
				>
					<Button
						...
						to="/apps/medicalCenter/medicalCenters/new"
					>
