...
export const getMedicalCenters = createAsyncThunk(
...
export const { selectAll: selectMedicalCenters, selectById: selectMedicalCenterById } =
	medicalCentersAdapter.getSelectors(state => state.medicalCentersManagement.medicalCenters);
