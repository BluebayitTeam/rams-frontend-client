...
export const removeTraining = createAsyncThunk(
    'trainingManagement/training/removeTraining',
    async (val) => {
...
export const updateTraining = createAsyncThunk(
    'trainingManagement/training/updateTraining',
    async (trainingData) => {
...
export const saveTraining = createAsyncThunk(
    'trainingManagement/training/saveTraining',
    async (trainingData) => {
...
const trainingSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateTraining.fulfilled]: (state, action) => action.payloHea
    }
})
