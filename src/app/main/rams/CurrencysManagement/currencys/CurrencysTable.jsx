...
function CurrencysTable(props) {
	...
	const { data, isLoading, refetch } = useGetCurrencysQuery({ ...pageAndSize, searchKey });
		...
		<div className="w-full flex flex-col min-h-full px-10">
			<FuseScrollbars className="grow overflow-x-auto">
				...
				>
					...
					<TableBody>
						{_.orderBy(currencys, [tableOrder.id], [tableOrder.direction]).map((n) => {
							...
							return (
								...
								>
									...
									>
										<Edit
											onClick={(event) => handleUpdateCurrency(n, 'updateCurrency')}
											className="cursor-pointer custom-edit-icon-style"
										/>

										<Delete
											onClick={(event) => handleDeleteCurrency(n, 'deleteCurrency')}
