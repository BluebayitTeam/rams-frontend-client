...
import { useDeleteGroupsMutation } from '../GroupsApi';

/**
 * The groups table head component.
 */
...
function GroupsTableHead(props) {
	const { selectedGroupIds, tableOrder, onSelectAllClick, onRequestSort, rowCount, onMenuItemClick } = props;
	...
	const numSelected = selectedGroupIds.length;
	...
	function handleDeleteMultipleItem() {
		removeGroups(selectedGroupIds).then((data) => {
			Swal.fire({
				position: 'top-center',
				icon: 'success',
