...
function DesignationsTableHead(props) {
	const { selectedDesignationIds, tableOrder, onSelectAllClick, onRequestSort, rowCount, onMenuItemClick } = props;
	const [removeDesignations] = useDeleteDesignationsMutation();
	const numSelected = selectedDesignationIds.length;
	const [selectedDesignationsMenu, setSelectedDesignationsMenu] = useState(null);
