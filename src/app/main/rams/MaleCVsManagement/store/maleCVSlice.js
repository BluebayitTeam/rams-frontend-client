...
export const removeMaleCV = createAsyncThunk(
    'maleCVManagement/maleCV/removeMaleCV',
    async (val) => {
...
export const updateMaleCV = createAsyncThunk(
    'maleCVManagement/maleCV/updateMaleCV',
    async (maleCVData) => {
...
export const saveMaleCV = createAsyncThunk(
    'maleCVManagement/maleCV/saveMaleCV',
    async (maleCVData) => {
...
const maleCVSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateMaleCV.fulfilled]: (state, action) => action.payloHea
    }
})
