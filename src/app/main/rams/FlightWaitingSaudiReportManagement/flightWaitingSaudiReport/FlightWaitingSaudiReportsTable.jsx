...
import { useGetFlightWaitingSaudiReportsQuery } from '../FlightWaitingSaudiReportsApi';
...
function FlightWaitingSaudiReportsTable(props) {
  ...
  const { data: paginatedData } = useGetFlightWaitingSaudiReportsQuery({
  ...
  useEffect(() => {
    if (!inShowAllMode && paginatedData) {
      setModifiedFlightFlightDoneData(paginatedData?.flight_waiting_data || []);
  ...
  return (
    <div className={classes.headContainer}>
      <ReportPaginationAndDownload
        ...
        filename='FlightWaitingSaudiReport'
      />
      <table
        id='table-to-xls'
        className='w-full'
...
export default FlightWaitingSaudiReportsTable;
