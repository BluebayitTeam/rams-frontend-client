...
import { z } from "zod";
import VisaStatussTable from "./VisaStatusTable";
...
const schema = z.object({
  first_name: z
    .string()
    .nonempty("You must enter a visaStatusReport name")
    .min(5, "The visaStatusReport name must be at least 5 characters"),
});
