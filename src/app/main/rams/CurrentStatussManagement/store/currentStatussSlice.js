...
export const getCurrentStatuss = createAsyncThunk(
...
export const { selectAll: selectCurrentStatuss, selectById: selectCurrentStatusById } =
	currentStatussAdapter.getSelectors(state => state.currentStatussManagement.currentStatuss);
