...
function CurrentStatussTable(props) {
	...
	const { data, isLoading, refetch } = useGetCurrentStatussQuery({ ...pageAndSize, searchKey });
	const totalData = useSelector(selectFilteredCurrentStatuss(data));
	const currentStatuss = useSelector(selectFilteredCurrentStatuss(data?.current_statuses));
	let serialNumber = 1;
