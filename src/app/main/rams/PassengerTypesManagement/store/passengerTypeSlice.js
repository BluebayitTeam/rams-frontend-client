...
import { CREATE_PASSENGERTYPE, DELETE_PASSENGERTYPE, GET_PASSENGERTYPE_BY_ID, UPDATE_PASSENGERTYPE } from '../../../../constant/constants';


export const getPassengerType = createAsyncThunk('passengerTypeManagement/passengerType/getPassengerType', async (params, { rejectWithValue }) => {
    const authTOKEN = {
        headers: {
...
const passengerTypeSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updatePassengerType.fulfilled]: (state, action) => action.payloHea
    }
})
