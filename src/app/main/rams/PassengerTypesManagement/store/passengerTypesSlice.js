...
export const getPassengerTypes = createAsyncThunk(
	'passengerTypeManagement/passengerTypes/getPassengerTypes',
	async pageAndSize => {
...
export const { selectAll: selectPassengerTypes, selectById: selectPassengerTypeById } =
	passengerTypesAdapter.getSelectors(state => state.passengerTypesManagement.passengerTypes);
