...
import { useDeletePassengerTypesMutation } from '../PassengerTypesApi';

/**
 * The passengerTypes table head component.
 */
...
function PassengerTypesTableHead(props) {
	const { selectedPassengerTypeIds, tableOrder, onSelectAllClick, onRequestSort, rowCount, onMenuItemClick } = props;

	console.log('onMenuItemClick', onMenuItemClick);

	console.log('selectedPassengerTypeIds', selectedPassengerTypeIds);

	const [removePassengerTypes] = useDeletePassengerTypesMutation();
	...
	function handleDeleteMultipleItem() {
		removePassengerTypes(selectedPassengerTypeIds).then((data) => {
			Swal.fire({
				position: 'top-center',
				icon: 'success',
						...
						>
							...
							>
								<MenuList>
									<MenuItem
										onClick={() => {
											removePassengerTypes(selectedPassengerTypeIds);
											onMenuItemClick();
