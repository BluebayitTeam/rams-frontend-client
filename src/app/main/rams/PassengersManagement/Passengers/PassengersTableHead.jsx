...
import { useDeletePassengersMutation } from '../PassengersApi';
/**
 * The table head rows data.
 */

/**
 * The passengers table head component.
 */
function PassengersTableHead(props) {
	const { selectedPassengerIds, tableOrder, onSelectAllClick, onRequestSort, rowCount, onMenuItemClick } = props;
	const [removePassengers] = useDeletePassengersMutation();
