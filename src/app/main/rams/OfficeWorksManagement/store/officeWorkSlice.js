...
export const removeOfficeWork = createAsyncThunk('officeWorkManagement/officeWork/removeOfficeWork', async val => {
	const authTOKEN = {
		headers: {
...
const officeWorkSlice = createSlice({
	...
	extraReducers: {
		...
		[updateOfficeWork.fulfilled]: (state, action) => action.payload
	}
});
