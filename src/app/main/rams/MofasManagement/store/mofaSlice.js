...
export const removeMofa = createAsyncThunk('mofaManagement/mofa/removeMofa', async val => {
	const authTOKEN = {
		headers: {
...
export const updateMofa = createAsyncThunk('mofaManagement/mofa/updateMofa', async mofaData => {
...
export const saveMofa = createAsyncThunk('mofaManagement/mofa/saveMofa', async mofaData => {
...
const mofaSlice = createSlice({
	...
	extraReducers: {
		...
		[updateMofa.fulfilled]: (state, action) => action.payload
	}
});
