	...
	return (
		<div className="flex flex-1 w-full items-center justify-between">
				...
				<div className="flex items-center max-w-full">
					...
					>
						{image && featuredImageId ? (
							...
							<img className="w-32 sm:w-48 rounded" src={`${BASE_URL}${image}`} alt={name} />
						)}
					</motion.div>
			...
			>
				...
				{handleDelete == 'Delete' && routeParams.demandId !== 'new' && (
					<Button
				...
				{handleDelete !== 'Delete' && routeParams?.demandName && (
					<Button
						className="whitespace-nowrap mx-4"
						color="secondary"
						variant="contained"
