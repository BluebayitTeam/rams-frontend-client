...
import {
  NOTE_SHEET_FEMALE_FOOTER,
  NOTE_SHEET_FEMALE_HEADER,
...
function ManpowerNoteSheetFemaleForm(props) {
  ...
  useEffect(() => {
    ...
    fetch(
      `${GET_FORM_CONTENT_DETAILS_BY_TITLE}${NOTE_SHEET_FEMALE_HEADER}`,
      authTOKEN
    )
    ...
    fetch(
      `${GET_FORM_CONTENT_DETAILS_BY_TITLE}${NOTE_SHEET_FEMALE_FOOTER}`,
      authTOKEN
    )
      .then((response) => response.json())
