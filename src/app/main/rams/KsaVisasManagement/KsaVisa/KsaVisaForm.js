...
function KsaVisaForm() {
	...
	const [barcodePpNo, setBarcodePpNo] = useState(0);
								...
								<td>
									<table width="100%">
										<tr>
											...
											<td style={{ width: '30%' }}>
												<table style={{ width: '300px', textAlign: 'Center', float: 'right' }}>
													<tr>
														<td>
									...
									>
										...
										<tr style={{ borderBottom: '1px solid black' }}>
											<td colspan="3">
												<table width="100%">
													<tr>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>
															Sex:&emsp;&emsp; Female&nbsp;أنثي&nbsp;&nbsp;Male&nbsp;
															{data.unknown}
														</td>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>
										...
										<tr style={{ borderBottom: '1px solid black', borderTop: '1px solid black' }}>
											...
											<td style={{ textAlign: 'left' }}>{data.unknown}</td>
												...
												<table width="100%">
													<tr>
														...
														>
															...
															<br />
															<b style={{ fontSize: '10pt' }}>{data.unknown}</b>
														</td>
														<td
															style={{
																textAlign: 'Center',
											...
											<td colspan="3">
												<table width="100%">
													<tr>
														...
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>Date:</td>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>( )</td>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>No.</td>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>Date:</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td colspan="3">
												<table width="100%">
													<tr>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>
															The undersigned hereby certify that all the information I
										...
										<tr>
											<td colspan="3">
												<table width="100%">
													<tr>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>
															I will abide by the laws of the Kingdom during the period of
															my residence in it.
														</td>
														<td style={{ textAlign: 'right', fontSize: '9.5pt' }}>
											...
											<td colspan="3">
												<table width="100%">
													<tr>
														...
														>
															<b style={{ fontSize: '13pt' }}>{data.unknown}</b>
															<span style={{ color: 'white', fontSize: '1px' }}>a</span>
														</td>
														<td
															style={{
											...
											<td colspan="3">
												<table width="100%">
													<tr>
														...
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>Type:</td>
														<td style={{ textAlign: 'right', fontSize: '9.5pt' }}>
															:&nbsp;نوعها
														</td>
														<td style={{ textAlign: 'left', fontSize: '9.5pt' }}>
										...
										<table width="93%">
											<tr>
												<td className="auto-style1" align="justify">
													...
													ALL NECESSARY DOCUMENT AND PARTICULARS MENTIONED AS BELOW, KNOWING
													ALL INSTRUCTIONS AND REGULATIONS OF THE CONSULATE SECTION:
													<br />
													<br />
												</td>
											</tr>
											...
											<tr>
												<td align="justify">
													...
													VISA FORM AND FORWARDING LETTER IS FULLY CORRECT. WE ALSO DO GIVEN
													THE UNDERTAKEN WITH OUR OWN RESPONSIBILTY TO CANCEL THE VISA AND TO
													STOP FUNCTIONING&nbsp; WITH OUR OFFICE, IF THE STATEMENT IS FOUND
													INCORRECT.
													<br />
													<br />
													WE, THEREFORE REQUEST YOUR EXCELLENCY TO KINDLY ISSUE WORK VISA OUT
													OF ....... VISA AND OBLIGE THERE BY.
													<br />
													<br />
													<br />
													<br />
						...
						<table width="100%">
							<tr>
								<td valign="top" align="center">
									<table width="95%">
										<tr>
											<td style={{ fontWeight: 'bold', fontSize: 'large', textAlign: 'center' }}>
												<br />
												<br />
												<br />
												<h3>
										...
										<tr>
											<td
												style={{ fontWeight: 'bold', fontSize: 'small', textAlign: 'center' }}
											></td>
										</tr>
										<tr>
											<td align="left">
												...
												>
													...
													<tr>
														...
														<td>
															...
															&nbsp;to the 2nd party as his monthly salary to serve him as
															a
													...
													<tr>
														...
														<td>OTHER TERMS & CONDITIONS NOT CONVERED BY THE AGREEMENT </td>
													...
													<tr>
														...
														<td>
															The 1st party shall grant leave to the 2nd party on usual
															holiday.
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															The period of this Agreement is 2 (two) years starting from
															signing the contact by the two parties.
														</td>
													</tr>
													<tr>
														<td style={{ width: '5%' }}>15.</td>
														<td>
															Each party should have one copy of this contact and if the
															two copies are found differnt have the one who made change
															should be punnished according to the Saudi Laws.
														</td>
													</tr>
													<tr>
														...
														<td>
															...
															provisions the Saudi Labour Laws and standard rules of the
															Kingdom shall apply.
														</td>
													</tr>
												</table>
										...
										<tr>
											<td>
												<table width="100%">
													<tr>
														<td>
															<div style={{ borderTop: '2px solid #000', float: 'left' }}>
																SIGNATURE OF THE 1ST PARTY
															</div>
														</td>
														<td>
															<div
																style={{ borderTop: '2px solid #000', float: 'right' }}
															>
