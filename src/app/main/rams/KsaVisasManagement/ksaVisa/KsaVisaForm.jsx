...
function KsaVisaForm(props) {
  ...
  const { data, refetch, isSuccess } = useGetKsaVisaQuery(ksaVisaId, {
    skip: !ksaVisaId,
  });
        ...
        <div className='row px-20 py-20'>
          <div className='md:w-full'>
            <div>
                  ...
                  <td>
                        ...
                        <td style={{ width: '30%' }}>
                          <table
                            ...
                            <tr>
                              <td>
                                <div
                                  style={{ float: 'right', fontSize: '9.5pt' }}>
                                  <table
                                    style={{
                                      width: '100%',
                                      textAlign: 'center',
                    ...
                    <table
                              ...
                              <td
                                ...
                                <b>
                                  {localData?.[0]?.passenger?.passenger_name &&
                                    `${localData?.[0]?.passenger?.passenger_name} ${
                                      localData?.[0]?.passenger?.gender
                                        ? localData?.[0]?.passenger?.gender?.match(
                                            /female/i
                                          )
                                          ? 'D/O'
                                          : 'S/O'
                          ...
                          <table width='100%'>
                            <tr>
                              ...
                              <td
                                ...
                                :&nbsp;الجنسية السابقة&emsp;&emsp;Present
                                nationality:
                              </td>
                              <td
                          ...
                          <table width='100%'>
                            <tr>
                              ...
                              <td
                                ...
                                <b>{localData?.[0]?.passenger?.religion}</b>
                              </td>
                              <td
                                style={{
                                  textAlign: 'right',
                        ...
                        <table width='100%'>
                          <tr style={{ borderBottom: '1px solid black' }}>
                            ...
                            <td
                              ...
                              Profession:&emsp;
                              <b>
                                {localData?.[0]?.passenger?.profession?.name}
                              </b>
                            </td>
                          </tr>
                        </table>
                      ...
                      <tr
                        ...
                        }, ${localData?.[0]?.passenger?.target_country?.name || ''}`}</td>
                        <td style={{ textAlign: 'right' }}>
                          ...
                          <table width='100%'>
                            <tr>
                              <td
                                ...
                                <b>{`${localData?.[0]?.agency?.name_arabic || ''} RL No- ${
                                  localData?.[0]?.passenger?.agency?.rl_no
                                    ?.toString()
                                    .replace(/[0-9]/g, (digit) =>
                                      String.fromCharCode(
                      ...
                      <tr style={{ borderBottom: '1px solid black' }}>
                        <td
                          ...
                          colSpan='3'>
                          <b>{localData?.[0]?.agency?.address}</b>
                        </td>
                      </tr>
                      <tr style={{ borderBottom: '1px solid black' }}>
                        <td colSpan='3'>
                          ...
                          <table width='100%'>
                            <tr>
                              ...
                              <td
                                ...
                                &nbsp;&nbsp;Date of passport's
                                expiry:&emsp;تاريخ إنتهاء صلاحية الجواز
                                <br />
                                <b style={{ fontSize: '10pt' }}>
                                  {localData?.[0]?.passenger
                        ...
                        <td colSpan='3'>
                          <table width='100%'>
                            <tr>
                              ...
                              <td
                                style={{ textAlign: 'left', fontSize: '9.5pt' }}
                              />
                              <td
                                style={{
                                  textAlign: 'right',
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'right' }}>
                          :إيضاحات تخص أفراد العائلة (المضافين) علي نفس جواز
                          السفر
                        </td>
                      </tr>
                      <tr>
                          ...
                          <table width='100%'>
                            <tr>
                              ...
                              <td
                                ...
                                :&nbsp;اسم وعنوان الشركة أو اسم الشخص وعنوان
                                بالمملكة
                              </td>
                            </tr>
                          </table>
                          ...
                          <table width='100%'>
                            <tr>
                              <td
                                ...
                                The undersigned hereby certify that all the
                                information I have provided are correct.
                              </td>
                              <td
                                style={{
                                  textAlign: 'right',
                                ...
                                .&nbsp;أنا الموقع أدناه أقر بأن كل المعلومات
                                التي دونها صحيصة
                              </td>
                            </tr>
                          </table>
                          ...
                          <table width='100%'>
                            <tr>
                              <td
                                ...
                                I will abide by the laws of the Kingdom during
                              ...
                              <td
                                ...
                                .&nbsp;وسأكون ملتزما بقوانين المملكة أثناء فترة
                                وجودي بها{' '}
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr style={{ borderBottom: '1px solid black' }}>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          ...
                          {localData?.[0]?.visa_entry?.sponsor_id_no}
                        </td>
                        <td style={{ textAlign: 'right' }}>
                          :&nbsp;أشر له برقم
                        </td>
                      ...
                      <table width='93%'>
                        <tr>
                          <td
                            ...
                            <br />
                            <br />
                            WITH DUE RESPECT WE ARE SUBMITTING ONE PASSPORT FOR
                            WORK VISA WITH ALL NECESSARY DOCUMENT AND
                        ...
                        <tr>
                          <td align='justify'>
                            <br />
                            WE DO HEREBY CONFIRM AND DECLARE THAT THE RELIGION
                            STATED IN THE VISA FORM AND FORWARDING LETTER IS
                            FULLY CORRECT. WE ALSO DO GIVEN THE UNDERTAKEN WITH
                            OUR OWN RESPONSIBILTY TO CANCEL THE VISA AND TO STOP
                            FUNCTIONING&nbsp; WITH OUR OFFICE, IF THE STATEMENT
                            IS FOUND INCORRECT.
                            <br />
                            <br />
                            WE, THEREFORE REQUEST YOUR EXCELLENCY TO KINDLY
                            ISSUE WORK VISA OUT OF ....... VISA AND OBLIGE THERE
                            BY.
                            <br />
                            <br />
                            <br />
              ...
              <table width='100%' className='print:mt-100'>
                <tr>
                  <td valign='top' align='center'>
                    <table width='95%'>
                      <tr>
                          ...
                          <table
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                &nbsp;to the 2nd party as his monthly salary to
                                serve him as a{' '}
                                <b>
                                  {localData?.[0]?.embassy?.profession_english}
                                </b>
                            ...
                            <tr>
                              ...
                              <td>
                                REPATRIATION ARRANGEMENT INCLUDING RETURN OF
                                DEAD & BODY SERVICE BENEFIT TO THE LEGAL HEIR OF
                                THE EMPOLYEE
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                OTHER TERMS & CONDITIONS NOT CONVERED BY THE
                                AGREEMENT{' '}
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                The 1st party shall grant leave to the 2nd party
                                on usual holiday.
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                The 2nd party shall observe the local Saudi Laws
                                and Traditions.
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                The period of this Agreement is 2 (two) years
                                starting from signing the contact by the two
                                parties.
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                Each party should have one copy of this contact
                                and if the two copies are found differnt have
                                the one who made change should be punnished
                                according to the Saudi Laws.
                              </td>
                            </tr>
                            <tr>
                              <td style={{ width: '5%' }}>16.</td>
                              <td>
                                Regarding all other matters not covered by the
                                above provisions the Saudi Labour Laws and
                                standard rules of the Kingdom shall apply.
                              </td>
                            </tr>
                          </table>
                        </td>
              ...
              {/* 3rd Page   */}
              <h2 className='print:mt-40' style={{ marginTop: '300px' }}>
                ...
                <tbody>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      style={{ borderRight: '1px solid' }}
                      className='font-bold'>
                      <center> {localData?.[0]?.passenger?.passport_no}</center>
                    </td>
                    <td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      style={{ borderRight: '1px solid' }}
                      className='font-bold'>
                      <center> {localData?.[0]?.passenger?.gender}</center>
                    </td>
                    <td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.musaned_okala?.musaned_status
                          ? localData?.[0]?.musaned_okala?.musaned_status
                          : 'N/A'}{' '}
                      </center>
                    </td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.musaned_okala?.okala_status
                          ? localData?.[0]?.musaned_okala?.okala_status
                          : 'N/A'}{' '}
                      </center>
                    </td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.medical?.medical_result
                          ? localData?.[0]?.medical?.medical_result
                          : 'N/A'}{' '}
                      </center>
                    </td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.office_work?.police_clearance_no
                          ? localData?.[0]?.office_work?.police_clearance_no
                          : 'N/A'}{' '}
                      </center>
                    </td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.office_work?.driving_license_no
                          ? localData?.[0]?.office_work?.driving_license_no
                          : 'N/A'}{' '}
                      </center>
                    </td>
                  ...
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.office_work?.certificate_experience
                          ? localData?.[0]?.office_work?.certificate_experience
                          : 'N/A'}{' '}
                      </center>
                    </td>
                    <td>
                      <center>
                        Certificate & Experience/ المؤهل وشهادة الخبرة
                      </center>
                    </td>
                  </tr>
                  <tr style={{ borderTop: '1px solid' }}>
                    ...
                    <td
                      ...
                      <center>
                        {' '}
                        {localData?.[0]?.office_work?.finger_no
                          ? localData?.[0]?.office_work?.finger_no
                          : 'N/A'}{' '}
                      </center>
                    </td>
              ...
              <br />
              <br />
              <table align='right' style={{ marginTop: '20px' }}>
                <tr>
                  <td className='font-bold'>
                    <b align='right'>
                      {localData?.[0]?.passenger?.agency?.name_arabic}
                    </b>
                  </td>
                  <td>
                ...
                <tr>
                  <td className='font-bold'>
                    {localData?.[0]?.passenger?.agency?.rl_no?.number
                      .toString()
                      .replace(/[0-9]/g, (digit) =>
