...
/**
 * The payorderClearings header.
 */
function PayorderClearingsHeader(props) {
			...
			<div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
				...
				>
					<Button
						...
						to="/apps/payorderClearing/payorderClearings/new"
					>
...
export default PayorderClearingsHeader;
