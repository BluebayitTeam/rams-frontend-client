...
import { useGetThailandVisaQuery } from '../ThailandVisasApi';
							...
							>
								<tr valign="middle">
									...
									>
										<center>
											<img
												src="assets/images/logos/thailandVisa.jpg"
												align="CENTER"
												width="120"
												height="120"
							...
							>
										...
										<table width="100%">
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Former Name (if any)</td>
															<td
																style={{
																	borderBottom: '1px solid black',
																	width: '100%',
										...
										<table width="100%">
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Nationality at Birth</td>
															<td
																style={{
																	borderBottom: '1px solid black',
																	width: '100%',
									...
									<table width="100%">
										<tr>
											...
											<td>
												<table width="100%">
													<tr>
														<td className="whitespace-nowrap">Marital Status</td>
														<td
															style={{
																borderBottom: '1px solid black',
																width: '100%',
								...
								<tr>
									...
									<td>
										<table>
											<tr>
												<td>Tel./Fax.</td>
												<td style={{ borderBottom: '1px solid black', width: '100%' }} />
											</tr>
										</table>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<table>
											<tr>
												<td>
													I hereby declare that I will not request any refund from my paid
													visa <br /> fee even if my application has been declined
													<br />
													<table width="100%">
														<tr>
															<td>
								...
								<tr>
										...
										<table width="100%">
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">(if accompanying)</td>
															<td
																style={{
																	borderBottom: '1px solid black',
																	width: '100%'
									...
									<td style={{ border: '1px solid black', marginTop: '50px' }}>
										...
										<p>
											I hereby declare that the purpose of my visit to Thailand | is for pleasure
											or transit only and that in no case shall I engage myself in any profession
											or occupation while in the country.{' '}
										</p>
										<table width="100%">
											<tr>
												<td>
										...
										<table width="100%">
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Travelling by </td>
															<td
																style={{
																	borderBottom: '1px solid black',
																	width: '100%'
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Purpose of Visit: </td>
															<td
																style={{
																	width: '100%'
																}}
										...
										<table className="border border-solid w-full">
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Type of Visa: </td>
															<td
																style={{
																	width: '100%'
																}}
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Category of Visa : </td>
															<td
																style={{
																	borderBottom: '1px solid black',
																	width: '100%'
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Number of Entries : </td>
															<td
																style={{
																	width: '100%'
																}}
											...
											<tr>
												<td>
													<table width="100%">
														<tr>
															<td className="whitespace-nowrap">Document Submitted: </td>
															<td
																style={{
																	borderBottom: '1px solid black',
																	width: '100%'
...
export default ThailandVisaForm;
