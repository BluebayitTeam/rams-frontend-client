...
export const updateVisaReissueList = createAsyncThunk(
    ...
    async (visaReissueListData) => {
        ...
        const response = await axios.put(`${UPDATE_VISAREISSUELIST}${visaReissueListData.id}`, visaReissueListData, authTOKEN);
        return response
    }
...
const visaReissueListSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateVisaReissueList.fulfilled]: (state, action) => action.payloHea
    }
})
