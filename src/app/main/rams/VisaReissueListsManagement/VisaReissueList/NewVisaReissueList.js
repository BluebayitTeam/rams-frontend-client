...
import { VISAREISSUELIST_BY_PASSENGER_ID } from 'app/constant/constants';
...
import NewVisaReissueListHeader from './NewVisaReissueListHeader';
								...
								render={({ field: { onChange, value, name } }) => (
									<Autocomplete
										...
										onChange={(event, newValue) => {
											if (newValue?.id) {
												axios
													.get(`${VISAREISSUELIST_BY_PASSENGER_ID}${newValue?.id}`)
													.then(res => {
														...
														if (res.data.id) {
															...
															history.push(
																`/apps/visaReissueList-management/visaReissueList/${
