...
export const getQualifications = createAsyncThunk('qualificationManagement/qualifications/geQualifications', async (parameter) => {
...
export const { selectAll: selectQualifications, selectById: selectQualificationById } = qualificationsAdapter.getSelectors(
    state => state.qualificationsManagement.qualifications
);
