...
import { useDeleteClientsMutation } from '../ClientsApi';
/**
 * The table head rows data.
 */

/**
 * The clients table head component.
 */
function ClientsTableHead(props) {
	const { selectedClientIds, tableOrder, onSelectAllClick, onRequestSort, rowCount, onMenuItemClick } = props;
	const [removeClients] = useDeleteClientsMutation();
