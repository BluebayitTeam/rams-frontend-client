    ...
    <div className="flex flex-col sm:flex-row space-y-12 sm:space-y-0 flex-1 w-full justify-between py-32 px-24 md:px-32">
      ...
      <div className="flex w-full sm:w-auto flex-1 items-center justify-end space-x-8">
        <Paper
          ...
          className="flex items-center w-full sm:max-w-[680px] space-x-8 px-16 rounded-full border-1 shadow-0"
        >
        ...
        >
          {hasPermission("MENU_ITEM_CREATE") && (
            <Button
              className="mx-8"
              variant="contained"
              color="secondary"
              component={NavLinkAdapter}
              to="/apps/menu/menus/new"
            >
