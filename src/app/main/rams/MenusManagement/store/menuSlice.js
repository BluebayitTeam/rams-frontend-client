...
export const removeMenu = createAsyncThunk('menuManagement/menu/removeMenu', async (val, { dispatch, getState }) => {
	const authTOKEN = {
		headers: {
			'Content-type': 'application/json',
			Authorization: sessionStorage.getItem('jwt_access_token')
...
export const saveMenu = createAsyncThunk('menuManagement/menu/saveMenu', async (menuData, { dispatch, getState }) => {
	const authTOKEN = {
		headers: {
			'Content-type': 'application/json',
			Authorization: sessionStorage.getItem('jwt_access_token')
