...
import { useCreateMenuMutation, useDeleteMenuMutation, useUpdateMenuMutation } from '../MenusApi';
	...
	return (
		<div className="flex flex-col sm:flex-row flex-1 w-full items-center justify-between space-y-8 sm:space-y-0 py-24 sm:py-32 px-24 md:px-32">
				...
				<div className="flex items-center max-w-full">
					...
					>
						{images && images.length > 0 && featuredImageId ? (
							...
							<img
								className="w-32 sm:w-48 rounded"
								src="assets/images/apps/ecommerce/menu-image-placeholder.png"
								alt={name}
							/>
						)}
					</motion.div>
			...
			>
				...
				{handleDelete !== 'deleteMenu' && handleUpdate === 'updateMenu' && menuId !== 'new' && (
					<Button
						className="whitespace-nowrap mx-4"
						color="secondary"
						variant="contained"
