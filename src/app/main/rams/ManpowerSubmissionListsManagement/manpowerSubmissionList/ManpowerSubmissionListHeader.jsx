			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					<Typography
						...
						color="inherit"
					>
						<span className="flex mx-4 font-medium">ManpowerSubmissionLists</span>
					</Typography>
				</motion.div>
				...
				<div className="flex items-center max-w-full">
					...
					>
						{images && images.length > 0 && featuredImageId ? (
							...
							<img
								className="w-32 sm:w-48 rounded"
								src="assets/images/apps/ecommerce/manpowerSubmissionList-image-placeholder.png"
								alt={name}
							/>
						)}
					</motion.div>
					...
					>
						<Typography className="text-16 sm:text-20 truncate font-semibold">
							{name || 'New ManpowerSubmissionList'}
						</Typography>
						<Typography
							variant="caption"
							className="font-medium"
						>
							ManpowerSubmissionList Detail
						</Typography>
					</motion.div>
				</div>
			</div>
