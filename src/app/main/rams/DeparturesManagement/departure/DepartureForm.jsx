...
function DepartureForm(props) {
  ...
  const { data, refetch, isSuccess } = useGetDepartureQuery(departureId, {
    skip: !departureId,
  });
  ...
  useEffect(() => {
    setDepartureId(routeParams?.departureId);
    if (routeParams?.departureId !== 'ksa-visa-form') {
      setValue('name', routeParams?.departureId);
    }
  }, [routeParams?.departureId, setValue]);
          ...
          <div className='md:w-full'>
            <div>
              ...
              <table width='100%' cellspacing='10' cellpadding='3'>
                  ...
                  <td>
                    <table>
                      <tr>
                        ...
                        <td rowspan='2' valign='middle'>
                          {
                            localData?.[0]?.passenger?.visa_entry
                              ?.passport_number
                          }
                        </td>
                      </tr>
                ...
                <tr>
                  <td>
                    <table style={{ justifyContent: 'center' }} width='40%'>
                      <tr>
                        <td
                          style={{
                  ...
                  <td>
                    <table style={{ justifyContent: 'center' }} width='10%'>
                      <tr>
                        <td
                          style={{
                            borderTop: '1px dashed black',
