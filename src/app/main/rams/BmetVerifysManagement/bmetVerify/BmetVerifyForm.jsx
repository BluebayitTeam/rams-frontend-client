...
function BmetVerifyForm(props) {
  ...
  useEffect(() => {
    ...
    if (routeParams?.bmetVerifyId !== 'bmetVerify-form') {
      setValue('passenger', routeParams?.bmetVerifyId);
    }
  }, [routeParams?.bmetVerifyId, setValue]);
            ...
            return (
              <Autocomplete
                ...
                onChange={(event, newValue) => {
                  console.log('Selected Passenger:', newValue); // Log the selected passenger object
            ...
            <div className='md:w-full'>
              <div>
                ...
                <p>
                  ...
                  <br />
                  <b>
                    বিষয়ঃ ০১ (এক) জন {bmetVerify?.gender} কর্মীর যাচাই বাচাই এর
                    জন্য আবেদন।{' '}
                  </b>
                  <br />
                  <br />
                  ...
                  {generalData?.agency_name_bangla} আর এল-{generalData?.rl_no}
                  ,সৌদি আরবের বিভিন্ন নিয়োকর্তার অধীনে নিয়োগ প্রাপ্তির মোট ০১
                  (এক) জন {bmetVerify?.gender} কর্মীর যাচাই বাচাই এর জন্য অনুমতি
                  প্রার্থনা করছি।
                  <br />
                  <br />
                </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ border: '1px solid black' }}>
                        {bmetVerify?.passenger_name}{' '}
                      </td>
                      <td style={{ border: '1px solid black' }}>
                        {bmetVerify?.passport_no}
                      </td>
                      <td style={{ border: '1px solid black' }}>
                ...
                <br />
                <p>
                  অতএব,জনাবের নিকট আকুল আবেদন এই য়ে , আমাকে সংযুক্ত ০১ (এক) জন{' '}
                  {bmetVerify?.gender} কর্মীর যাচাই বাচাই এর জন্য ছাড়পএ প্রানের
                  যথাযথ ব্যবস্থা গ্রহন করলে বাধিত হবো।
                </p>
                <br />
                <br />
                <br />
                ...
                <div className='text-right mr-'>
                  মালিক/ব্যবস্থাপনা পরিচালক/অংশীদার সীল{' '}
                </div>{' '}
                <br />
              </div>
            </div>
