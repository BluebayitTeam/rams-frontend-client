...
import NewRecruitingAgencyHeader from './NewRecruitingAgencyHeader';
...
const RecruitingAgency = () => {
	...
	const recruitingAgency = useSelector(
		({ recruitingAgencysManagement }) => recruitingAgencysManagement.recruitingAgency
	);
