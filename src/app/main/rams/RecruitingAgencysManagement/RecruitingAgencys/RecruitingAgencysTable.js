        ...
        <div className="w-full flex flex-col">
            <FuseScrollbars className="flex-grow overflow-x-auto">
                <Table stickyHeader className="min-w-xl" aria-labelledby="tableTitle">
                    ...
                    <TableBody>
                        {_.orderBy(
                            searchText !== "" && !_.isEmpty(searchRecruitingAgency) ? searchRecruitingAgency : recruitingAgencys,
                            [
                                o => {
                                    switch (order.id) {
                                        case 'categories': {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="p-4 md:p-16" align="center" component="th" scope="row">
                                            <div>
                                                <EditIcon onClick={recruitingAgencyEvent => handleUpdateRecruitingAgency(n)} className="cursor-pointer" style={{ color: 'green' }} /> <DeleteIcon onClick={event => handleDeleteRecruitingAgency(n, "Delete")} className="cursor-pointer" style={{ color: 'red' }} />
                                            </div>
                                        </TableCell>
