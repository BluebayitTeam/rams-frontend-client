...
export const getRecruitingAgencys = createAsyncThunk('recruitingAgencyManagement/recruitingAgencys/geRecruitingAgencys', async (pageAndSize) => {
...
export const { selectAll: selectRecruitingAgencys, selectById: selectRecruitingAgencyById } = recruitingAgencysAdapter.getSelectors(
    state => state.recruitingAgencysManagement.recruitingAgencys
);
