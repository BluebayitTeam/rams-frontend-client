...
function CallingEntryDetail({ classes, data, pid }) {
    ...
    <>
      <div
        ...
        <div
          ...
          <div className='container flex-col md:flex-row'>
            ...
            <div className='rightRow w-full md:w-1/2 pl-2 md:pl-16 pr-2 md:pr-16'>
              ...
              <b
                ...
                style={{ color: 'black' }}>
                {data?.sponsor_dob
                  ? moment(new Date(data.sponsor_dob)).format('DD/MM/YYYY')
                  : ''}
              </b>
            </div>
          </div>
          ...
          <div className='container flex-col md:flex-row'>
            <div className='rightRow w-full md:w-1/2 pl-2 md:pl-16 pr-2 md:pr-16'>
              <i className='label text-xs md:text-sm'>Calling Exp Date:</i>
              <b
                className='value text-xs md:text-sm'
                style={{ color: 'black' }}>
                {data?.calling_exp_date
                  ? moment(new Date(data.calling_exp_date)).format('DD/MM/YYYY')
                  : 'N/A'}
              </b>
            </div>
            <div className='border hidden md:block'></div>
...
export default CallingEntryDetail;
