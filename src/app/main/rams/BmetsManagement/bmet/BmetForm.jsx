          ...
          <div className='md:w-full'>
            <div>
              <table width='100%' cellPadding='7' cellSpacing='1'>
                <tr valign='middle'>
                  <td valign='middle' style={{ width: '14%', padding: 0 }}>
                    <img
                  ...
                  <td colSpan='2' style={{ border: 'none', padding: '0in' }}>
                    <p className='western'>
                      <span face='Calibri-Bold, sans-serif'>
                        <span size='2' style={{ fontSize: '9pt' }}>
                          <b>
                            B. Employer /Company/ foreign recruiting agent
                            Information
                          </b>
                        </span>
                      </span>
                  ...
                  <td colSpan='2' style={{ border: 'none', padding: '0in' }}>
                    <p className='western'>
                      <span color='#000000'>
                        <span face='Calibri, sans-serif'>
                          <span size='2' style={{ fontSize: '9pt' }}>
                            7. Employer is a company or recruiting agent
                            (foreign):{' '}
                          </span>
                        </span>
                      </span>
