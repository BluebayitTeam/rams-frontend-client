...
function TicketdeputeFilterMenu({
  inShowAllMode,
  handleGetTicketdeputes,
  handleGetAllTicketdeputes,
}) {
  ...
  const commonFieldProps = {
    setReRender,
    onEnter: () =>
      inShowAllMode ? handleGetAllTicketdeputes() : handleGetTicketdeputes(),
  };
...
export default TicketdeputeFilterMenu;
