...
import { CREATE_DEPARTMENT, DELETE_DEPARTMENT, GET_DEPARTMENTID, UPDATE_DEPARTMENT } from '../../../../constant/constants';


export const getDepartment = createAsyncThunk('departmentManagement/department/getDepartment', async (params, { rejectWithValue }) => {
  const authTOKEN = {
    headers: {
