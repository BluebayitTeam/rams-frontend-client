...
import { CREATE_VISASUBMISSIONLIST, DELETE_VISASUBMISSIONLIST, UPDATE_VISASUBMISSIONLIST } from '../../../../constant/constants';
...
export const updateVisaSubmissionList = createAsyncThunk(
    ...
    async (visaSubmissionListData) => {
        ...
        const response = await axios.put(`${UPDATE_VISASUBMISSIONLIST}${visaSubmissionListData.id}`, visaSubmissionListData, authTOKEN);
        return response
    }
...
const visaSubmissionListSlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateVisaSubmissionList.fulfilled]: (state, action) => action.payloHea
    }
})
