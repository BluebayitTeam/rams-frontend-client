								...
								render={({ field: { onChange, value, name } }) => (
									<Autocomplete
										...
										onChange={(event, newValue) => {
											if (newValue?.id) {
												axios
													.get(`${VISASUBMISSIONLIST_BY_PASSENGER_ID}${newValue?.id}`)
													.then(res => {
														...
														if (res.data.id) {
															...
															history.push(
																`/apps/visaSubmissionList-management/visaSubmissionList/${
																	newValue?.passenger_id || newValue?.id
																}`
															);
														} else {
															history.push(
																`/apps/visaSubmissionList-management/visaSubmissionList/new`
															);
