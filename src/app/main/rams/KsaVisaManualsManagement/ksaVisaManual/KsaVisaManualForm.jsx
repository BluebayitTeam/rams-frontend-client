          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <Autocomplete
                ...
                freeSolo
                value={
                  value ? religions.find((data) => data.id === value) : null
                }
                options={religions}
          ...
          <div className='row'>
            <div className='md:w-full'>
              <div>
                    ...
                    <td>
                      ...
                      <table
                            ...
                            <table width='100%'>
                              <tr>
                                ...
                                <td
                                  ...
                                  :&nbsp;تاريخ الولادة&emsp;&emsp;Place of
                                  birth:
                                </td>
                                <td
                                  style={{
                        ...
                        <tr>
                          ...
                          <td
                            style={{ textAlign: 'right', fontFamily: 'Arial' }}>
                            ...
                            <table width='100%'>
                              <tr>
                                <td
                                  ...
                                  Name and address of company or individual in
                                  the kingdom:
                                </td>
                                <td
                                  style={{
                            ...
                            <table width='100%'>
                              <tr>
                                ...
                                <td
                                  ...
                                  .&nbsp;وسأكون ملتزما بقوانين المملكة أثناء
                                  فترة وجودي بها{' '}
                                </td>
                              </tr>
                            </table>
                ...
                <br />
                          ...
                          <tr>
                            <td align='justify'>
                              ...
                              FULLY CORRECT. WE ALSO DO GIVEN THE UNDERTAKEN
                              WITH OUR OWN RESPONSIBILTY TO CANCEL THE VISA AND
                              TO STOP FUNCTIONING&nbsp; WITH OUR OFFICE, IF THE
                              STATEMENT IS FOUND INCORRECT.
                              <br />
                              <br />
                              WE, THEREFORE REQUEST YOUR EXCELLENCY TO KINDLY
                              ISSUE WORK VISA OUT OF ....... VISA AND OBLIGE
                              THERE BY.
                              <br />
                              <br />
                              <br />
                            ...
                            <table
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  &nbsp;to the 2nd party as his monthly salary
                                  to serve him as a{data?.profession_english}
                                  &nbsp;
                                </td>
                                <td>:SR 1000/-</td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  DEAD & BODY SERVICE BENEFIT TO THE LEGAL HEIR
                                  OF THE EMPOLYEE
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                  The 1st party shall grant leave to the 2nd
                                  party on usual holiday.
                                </td>
                              </tr>
                              <tr>
                                <td style={{ width: '5%' }}>13.</td>
                                <td>
                                  The 2nd party shall observe the local Saudi
                                  Laws and Traditions.
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  Each party should have one copy of this
                                  contact and if the two copies are found
                                  differnt have the one who made change should
                                  be punnished according to the Saudi Laws.
                                </td>
                              </tr>
                              <tr>
                ...
                {/* 3rd Page   */}
                <h2 className='print:mt-100' style={{ marginTop: '200px' }}>
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderTop: '1px solid' }}>
                      ...
                      <td style={{ borderRight: '1px solid' }}>
                        <center>
                          {' '}
                          {data?.musaned_no ? data?.musaned_no : 'N/A'}{' '}
                        </center>
                      </td>
                      <td>
                    ...
                    <tr style={{ borderTop: '1px solid' }}>
                      ...
                      <td style={{ borderRight: '1px solid' }}>
                        <center>
                          {' '}
                          {data?.okala_no ? data?.okala_no : 'N/A'}{' '}
                        </center>
                      </td>
                      <td>
                    ...
                    <tr style={{ borderTop: '1px solid' }}>
                      ...
                      <td style={{ borderRight: '1px solid' }}>
                        <center>
                          {' '}
                          {data?.finger_no ? data?.finger_no : 'N/A'}{' '}
                        </center>
                      </td>
                      <td>
