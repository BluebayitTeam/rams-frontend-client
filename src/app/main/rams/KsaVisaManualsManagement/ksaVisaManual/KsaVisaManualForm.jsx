													...
													<td colSpan="3">
														<table width="100%">
															<tr>
																...
																>
																	&nbsp;&nbsp;Date of passport's expiry:&emsp;تاريخ
																	إنتهاء صلاحية الجواز
																	<br />
																	<b style={{ fontSize: '10pt' }}>
													...
													<td colSpan="3">
														<table width="100%">
															<tr>
																...
																>
																	.&nbsp;أنا الموقع أدناه أقر بأن كل المعلومات التي
																	دونها صحيصة
																</td>
															</tr>
														</table>
											...
											>
												<table width="93%">
													...
													<tr>
														<td align="justify">
															<br />
															WE DO HEREBY CONFIRM AND DECLARE THAT THE RELIGION STATED IN
															THE VISA FORM AND FORWARDING LETTER IS FULLY CORRECT. WE
															ALSO DO GIVEN THE UNDERTAKEN WITH OUR OWN RESPONSIBILTY TO
															CANCEL THE VISA AND TO STOP FUNCTIONING&nbsp; WITH OUR
															OFFICE, IF THE STATEMENT IS FOUND INCORRECT.
															<br />
															<br />
															WE, THEREFORE REQUEST YOUR EXCELLENCY TO KINDLY ISSUE WORK
															VISA OUT OF ....... VISA AND OBLIGE THERE BY.
															<br />
															<br />
															<br />
															<br />
														...
														>
															...
															<tr>
																...
																<td>
																	...
																	serve him as a{data?.profession_english}
																	&nbsp;
																</td>
																<td>:SR 1000/-</td>
															</tr>
															...
															<tr>
																...
																<td>
																	REPATRIATION ARRANGEMENT INCLUDING RETURN OF DEAD &
																	BODY SERVICE BENEFIT TO THE LEGAL HEIR OF THE
																	EMPOLYEE
																</td>
															...
															<tr>
																...
																<td>
																	Each party should have one copy of this contact and
																	if the two copies are found differnt have the one
																	who made change should be punnished according to the
																	Saudi Laws.
																</td>
															</tr>
															<tr>
																...
																<td>
																	...
																	provisions the Saudi Labour Laws and standard rules
																	of the Kingdom shall apply.
																</td>
															</tr>
														</table>
													</td>
										...
										<tr style={{ borderTop: '1px solid' }}>
											...
											<td style={{ borderRight: '1px solid' }}>
												<center>
													...
													Months{' '}
													{data?.date_of_birth
														? differenceInDays(new Date(), new Date(data?.date_of_birth)) %
															30
														: ''}{' '}
													Days
												</center>
