...
export const removeAgent = createAsyncThunk('agentManagement/agent/removeAgent', async val => {
	const authTOKEN = {
		headers: {
			'Content-type': 'application/json',
			Authorization: sessionStorage.getItem('jwt_access_token')
...
export const saveAgent = createAsyncThunk('agentManagement/agent/saveAgent', async agentData => {
