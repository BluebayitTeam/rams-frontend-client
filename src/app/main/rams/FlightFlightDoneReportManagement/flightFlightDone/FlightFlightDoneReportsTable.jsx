...
} from '../FlightFlightDoneReportsApi';
...
function FlightFlightDoneReportsTable(props) {
  ...
  const { data: paginatedData } = useGetFlightFlightDoneReportsQuery({
    skip: inShowAllMode,
  });

  const { data: allData } = useGetFlightFlightDoneAllReportsQuery({
    skip: !inShowAllMode,
  });
  ...
  return (
    <div className={classes.headContainer}>
      <ReportPaginationAndDownload
        ...
        filename='FlightFlightDoneReport'
      />
      <table
        id='table-to-xls'
        className='w-full'
...
export default FlightFlightDoneReportsTable;
