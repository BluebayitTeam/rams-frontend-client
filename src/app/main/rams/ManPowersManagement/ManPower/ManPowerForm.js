	...
	return (
		<div>
			...
			<Controller
				...
				control={control}
				render={({ field }) => {
					return <CustomDatePicker field={field} label="Man Power Date" />;
				}}
			/>
			...
			<Controller
				...
				control={control}
				render={({ field }) => {
					return <CustomDatePicker field={field} label="Submit Date" />;
				}}
			/>
			...
			<Controller
				...
				control={control}
				render={({ field }) => {
					return <CustomDatePicker field={field} label="Delivery Date" />;
				}}
			/>
