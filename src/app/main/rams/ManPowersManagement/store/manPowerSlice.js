...
export const removeManPower = createAsyncThunk('manPowerManagement/manPower/removeManPower', async val => {
	const authTOKEN = {
		headers: {
...
export const updateManPower = createAsyncThunk('manPowerManagement/manPower/updateManPower', async manPowerData => {
...
export const saveManPower = createAsyncThunk('manPowerManagement/manPower/saveManPower', async manPowerData => {
...
const manPowerSlice = createSlice({
	...
	extraReducers: {
		...
		[updateManPower.fulfilled]: (state, action) => action.payload
	}
});
