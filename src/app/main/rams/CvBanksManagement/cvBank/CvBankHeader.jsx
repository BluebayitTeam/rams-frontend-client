...
import { useCreateCvBankMutation, useDeleteCvBankMutation, useUpdateCvBankMutation } from '../CvBanksApi';
...
function CvBankHeader() {
	...
	return (
		<div className="flex flex-col sm:flex-row flex-1 w-full items-center justify-between space-y-8 sm:space-y-0 py-24 sm:py-32 px-24 md:px-32">
			...
			>
				{handleDelete === 'deleteCvBank' && cvBankId !== 'new' && (
					<Button
				...
				{handleDelete !== 'deleteCvBank' && handleUpdate === 'updateCvBank' && cvBankId !== 'new' && (
					<Button
